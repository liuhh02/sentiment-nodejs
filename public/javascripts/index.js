const submitReview = (e) => {
  ...
  fetch('/api/nlp/s-analyzer', options)
    ...
    .then (({ analysis }) => {
      ...
      if (analysis < 0) {
        emojiSection.innerHTML = '<img src="https://img.icons8.com/emoji/96/000000/pouting-face.png"/>';
        title.style.color = 'red';
        outline.style.borderColor = 'red';
      };
      if (analysis === 0) {
        emojiSection.innerHTML = '<img src="https://img.icons8.com/emoji/96/000000/neutral-face.png"/>';
        title.style.color = '#00367c';
        outline.style.borderColor = '#00367c';
      }
      if (analysis > 0) {
        emojiSection.innerHTML = '<img src="https://img.icons8.com/emoji/96/000000/smiling-face-with-hearts.png"/>';
